					...
					<div id="sign_in" class="item_wrapper">
						...
						<form method="post" action="Logon" id="sign_in_form" name="sign_in_form">
							<fieldset>
								...
								<input type="text" id="login_id" style="text-transform:uppercase;" name="logonId" class="inputfield input_width_standard" placeholder="<fmt:message bundle="${storeText}" key="MLOGON_ID"/>" />
