									...
									<div id="box">
										...
										<c:choose>
                                            ...
                                            <div class="left left_confirmation_page" id="WC_OrderShippingBillingConfirmationPage_div_32">
                                                <a href="#" role="button" id="WC_OrderShippingBillingConfirmationPage_Print_Link" tabindex="0" onclick="JavaScript: print();">
                                                    <img src="<c:out value='${jspStoreImgDir}images/'/>ic_print.png">
                                                    <!-- <%-- ocultamos el boton texto de imprimir para colocar el icono
                                                    <div class="left_border"></div>
                                            ...
                                            <div class="left" id="WC_OrderShippingBillingConfirmationPage_div_35">
