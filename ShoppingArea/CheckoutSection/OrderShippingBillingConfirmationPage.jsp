								...
								<div class="row">
									<div class="col12 acol12">
										...
										<div id="checkout_crumb">
	                                    	...
	                                    	--%>
	                                    	<div class="right left_confirmation_page" id="WC_OrderShippingBillingConfirmationPage_div_32">
												<a href="#" role="button" class="" id="WC_OrderShippingBillingConfirmationPage_Print_Link" tabindex="0" onclick="JavaScript: print();">
													<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px" width="100%" height="100%" xml:space="preserve"><g class="shape" style="-webkit-transform: scale(0.66666666666667, 0.66666666666667);-moz-transform: scale(0.66666666666667, 0.66666666666667);transform: scale(0.66666666666667, 0.66666666666667);"><defs></defs><rect fill="#b3b3b3" display="none" width="24" height="24"></rect><rect fill="#b3b3b3" id="_x3C_Slice_x3E__81_" display="none" width="24" height="24"></rect><path fill="#b3b3b3" fill-rule="evenodd" clip-rule="evenodd" d="M18,17H6v1h12V17z M5,1h9v5h5v2h1V5l-5-5H4v8h1V1z M21,9H3c-2,0-3,1-3,3v6h4v6h16 v-6h4v-6C24,10,23,9,21,9z M4,13H2v-2h2V13z M19,23H5v-7h14V23z M18,19H6v1h12V19z M18,21H6v1h12V21z"></path></g></svg>
													...
													<c:otherwise>
														<c:choose>
															<c:when test="${WCParam.isQuote eq true}">
																...
																<p class="confirmacion"><fmt:message bundle="${storeText}" key="ORD_CONFIRMATION_MESSAGE_QUOTE"/></p>
															</c:when>
															<c:otherwise>
																<h1 class="breadcrumb_current"><fmt:message bundle="${storeText}" key="ORD_THANKS_MESSAGE"/></h1>
																<p class="confirmacion"><fmt:message bundle="${storeText}" key="ORD_CONFIRMATION_MESSAGE"/></p>
															</c:otherwise>
														</c:choose>
													</c:otherwise>                     
												</c:choose>
